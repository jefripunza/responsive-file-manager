...
$config = array(
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Maximum size of all files in ngodingyuk folder
    |--------------------------------------------------------------------------
    |
    | in Megabytes
    |
    ...
    */
    ...
    'ext_file'                                => array( 
        ...
        'psd', 'ai', 
        'kmz', 'dwg', 'dxf', 'plt', 'step', 'stp', 
        'fla', 'iges', 'igs', 'sat', 'cgm', 
    ...
    *******************/
    ...
    // Remember than the image creation respect the folder hierarchy so if you are inside ngodingyuk/test/test1/ the new image will create at
    ...
    */
    ...
    // The image creation path is always relative so if i'm inside ngodingyuk/test/test1 and I upload an image, the path start from here
    //
